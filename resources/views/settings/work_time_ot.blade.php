            ...
            <div class="modal-body">
                <form id="save-work-time" method="post">
                    ...
                    <div class="form-group">
                        <label>ชื่อ</label>
                        <input type="text" class="form-control" name="name" id="name" placeholder="ex : ot ประจำวันหยุด" required>
                    </div>                    
                    <div class="form-group">
                        <label>อัตราการได้รับ(%)</label>
                        <div class="input-group">
                            <input type="number" class="form-control" name="ratio_rate" id="ratio_rate" placeholder="ex : 100" required>
                            <div class="input-group-addon">%</div>
                          </div>                      
                       
                    </div>
                    <div class="form-group">
                        <label>การคิดเงิน</label>
                        <select name="time_rate" id="time_rate" class="form-control selectpicker">
...
<script>
    ...
    function edit(id) {
        $.post("/get-worktime-ot", data = {
                _token: "{{ csrf_token()}}",
                id: id
            },
            function (res) {
                urls = '/work-time-ot-edit';
        ...
        "columns": [{
            ...
            },         
            {
                ...
                "render": function (data) {
                    return `<button class="btn btn-warning btn-sm" onclick="edit(${data})">แก้ไข</button>`;
